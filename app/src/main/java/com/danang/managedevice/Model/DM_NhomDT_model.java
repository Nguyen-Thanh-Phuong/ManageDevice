...
public class DM_NhomDT_model implements ComunicationData {
    //public static DM_NhomDT_model instances = new DM_NhomDT_model();
    ...
    public DM_NhomDT_model(DMNhomDT nhomDT, Status stt, Context context) {
        this.nhomDT = nhomDT;
        this.stt = stt;
        this.context = context;
        exec();
    }
    public DM_NhomDT_model(Status stt, SendData send) {
        this.stt = stt;
        this.send = send;
        exec();
    }

    public DM_NhomDT_model(DMNhomDT nhomDT, Status stt, SendData send) {
        this.nhomDT = nhomDT;
        this.stt = stt;
        this.send = send;
        exec();
